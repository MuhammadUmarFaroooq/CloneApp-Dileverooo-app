...
const BottomSheet = forwardRef<Ref>((props, ref) => {
  ...
  {
    return (
      <BottomSheetModal style={{backgroundColor: Colors.lightGrey, borderRadius:0 }} overDragResistanceFactor={0} ref={ref} snapPoints={snapPoints} backdropComponent={renderbackdrop}>
